        ...
        o.Popup_A = class {
            ...
            static message(header, message, callback = null, style = null) {
                ...
                let model = {
                    ...
                    footer: [
                        { type: "button", highlight: true, text: "OK", action: FPComponents.Popup_A.OK }
                    ]
                }
            ...
            static confirm(header, message, callback = null, style = null) {
                ...
                let model = {
                    ...
                    footer: [
                        { type: "button", text: "Cancel", action: FPComponents.Popup_A.CANCEL },
                        { type: "button", highlight: true, text: "OK", action: FPComponents.Popup_A.OK },
                    ]
                }
                        ...
                        switch (item.type) {
                            case "button":
                                ...
                                if (item.closeDialog === false) {
                                    btn.onclick = () => { this._callback(item.action) };
                                } else {
            ...
            static _show(model) {
                if (model) {
                    ...
                    this._bgDiv.style.display = "flex";
                    return;
                }
            }
