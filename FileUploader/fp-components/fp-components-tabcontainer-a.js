    ...
    if (!o.hasOwnProperty("Tabcontainer_A")) {
        o.Tabcontainer_A = class {
            ...
            addTab(title, contentElement, makeActive=false) {
                ...
                this._tabQueue.push({id,title,contentElement,makeActive});
                this._updateTabs();
            ...
            removeTab(id) {
                this._tabQueue.push({id,delete:true});
                this._updateTabs();
            }
                ...
                if (!this._dirty) {
                    ...
                    window.setTimeout(()=>{
                        ...
                        if (this._root !== null) {
                            ...
                            // Update tab status and switch content and set exising scroll value
                            for (t of this._tabs) {
                                if (t.id === this._activeTabId) {
                                    ...
                                    (function(t,scope){
                                        window.setTimeout(()=>{scope._contentPane.scrollTop = t.scrollTop;},0);
                                    })(t,this);
            ...
            _addTabImpl(t) {
                ...
                // Add click actions to tabs and x-buttons
                (function (id, scope){
            ...
            _removeTabImpl(t) {
                ...
                for (let x=0; x<this._tabs.length; x++) {
                    ...
                    if (t2.id === t.id) {
                        ...
                        // If active id was removed, we need to make another tab active if possible
                        if (this._activeTabId === t2.id) {

                            // Decide which tab to move to, if any remaining
                            let newIx;
                            if (this._tabBar.clientWidth !== this._tabBar.scrollWidth && 
            ...
            _rebuild() {
                ...
                let container   = document.createElement("div");    container.className     ="fp-components-tabcontainer";

                let leftButton  = document.createElement("div");    leftButton.className    ="fp-components-tabcontainer-sidebutton";
                let rightButton = document.createElement("div");    rightButton.className   ="fp-components-tabcontainer-sidebutton";
                let plusButton  = document.createElement("div");    plusButton.className    ="fp-components-tabcontainer-sidebutton";
                let dynSpace    = document.createElement("div");    dynSpace.className      ="fp-components-tabcontainer-dynspace";

                let tabBar      = document.createElement("div");    tabBar.className        ="fp-components-tabcontainer-tabbar";
