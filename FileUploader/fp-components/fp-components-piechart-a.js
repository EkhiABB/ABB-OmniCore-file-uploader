    ...
    if (!o.hasOwnProperty("Piechart_A")) {
        o.Piechart_A = class {
            ...
            set hue(h) {
                ...
                if (h2 === -0) {
                    // To handle the silly "-0" case of JavaScript
                    h2 = 0;
                }
                this._hue = h2;
                this._update();
            ...
            _update() {
                ...
                function calcCoordinate(centerX, centerY, radius, deg) {
                    ...
                    var radians = (deg-90+ROTATION)*(Math.PI/180.0);
                    return {
                ...
                // +++ Auto-generate colors not specified by the user
                ...
                const createSector = (i) => {
                    ...
                    // if (isSelected) {
                    //     path.setAttribute("style","filter: drop-shadow( 2px 2px 1px rgba(0, 0, 0, .2));");
                    // }
