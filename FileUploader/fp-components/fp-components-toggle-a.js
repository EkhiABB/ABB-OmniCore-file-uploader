            ...
            _updateFromModel() {
                ...
                if (Array.isArray(this._model)) {
                    ...
                    for (const item of this._model) {
                        ...
                        // if element is outside previous togglestate, model has new item and should be added to togglestate.
                        if(this._toggleState.length <= i) {
                            this._toggleState.push(false);
                        } else {
                            // init already present buttons to correct state
